            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Tambah Meja Baru</h4>
                    ...
                    <form method="POST" action="{{ route('meja.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_meja') is-invalid @enderror" 
                                   id="kode_meja" name="kode_meja" value="{{ old('kode_meja') }}" 
                                   placeholder="Contoh: STD01, FAM01, VIP01" required>
                            @error('kode_meja')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Kode unik untuk identifikasi meja</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('kapasitas') is-invalid @enderror" 
                                   ...
                                   min="1" max="20" required placeholder="Jumlah orang">
                            @error('kapasitas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Meja tidak aktif tidak bisa dipesan</div>
                        </div>
